...
function player(furl,width,height,autostart,startpic,baseurl){
	...
	cfiletype='|'+filetype+'|';
        ...
        if(typeof(startpic)=="undefined")
         {
           //startpic="start.jpg";
           startpic="yazhuoplayer/start.png";
         }
...
function ShowPaplayer(furl,width,height,autostart,startpic,baseurl)
 {
    ...
    str+='var so = new SWFObject("paplayer.swf","ply","'+width+'","'+height+'","9","#000000");so.addParam("allowfullscreen","true");so.addParam("allowscriptaccess","always");so.addParam("wmode","opaque");so.addParam("quality","high");so.addParam("salign","lt");so.addVariable("JcScpFile","set.xml");';
...
document.write('<script type="text/javascript" src="yazhuoplayer/swfobject.js"></script>');