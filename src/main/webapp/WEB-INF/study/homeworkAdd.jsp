...
<body class="exam_bg" onbeforeunload="return '确认试卷提交才可以关闭窗口,否则考试信息将丢失，后果自负哦!';">
   <div class="content_exam">
     <div class="exam-title-top">
        ...
        <p class="alt"><span style="float: left;padding-left:25px">姓名：${name}</span><span style="float: right;padding-right:25px">开始时间：${startDate}</span></p>
        <p id="showtime"></p>  
   ...
   success: function(data){
   	if(data.flag==1){
			  layer.alert(data.msg,{icon:1},function(){
				  window.location.href="${res}/work/getHomeWork.html";
			  });
		  }else{
