...
<!--/个人中心栏目-->
   ...
   <div class="mian_right minHeight500">
      <h2 class="main_right_h2">未通过的课程</h2>
           ...
           <img src="${res}/student/img/test/2.png">
              ...
              <div class="txt">
                ...
                <div class="alink">
                  ...
                  <div><span class="courseSituation isNo">未通过</span></div>              
                </div>
              </div>
          </div><!--单挑数据-->
          </c:forEach>
    ...
    <div class="page2">
      ...
      <a href=" 
      <c:if test="${pageNum>1}">${res}/study/toUnpassCourse.html?pageNum=${pageNum-1}</c:if>
      <c:if test="${pageNum<=1}">${res}/study/toUnpassCourse.html?pageNum=1</c:if>
      " >上一页</a>
      ...
      <a href="
      <c:if test="${pageNum<pageCount}">${res}/study/toUnpassCourse.html?pageNum=${pageNum+1}</c:if>
      <c:if test="${pageNum>=pageCount}">${res}/study/toUnpassCourse.html?pageNum=${pageCount}</c:if>
      "
      >下一页</a>
    </div>
    </c:if>
