		...
		<div class="formbody">
			...
			<div class="padding5">
				...
				<div class="box-course">
						...
						<table class="form_table" width="100%" cellspacing="0"
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="hidden" name="courseId" class="courseId" id="courseId"
								...
								<tr>
									...
									<td class="f2" style="display:none"><img id="upload_org_code_img" fN="" src="${course.cover.maxUrl}" width="150" height="150">
											...
											<table width="100%" cellspacing="0" cellpadding="0"
												...
												<thead>
													<tr>
														...
														<td width="30%" valign="middle" align="center">专家姓名</td>
												...
												<tr>
													...
													<!-- <input
														...
														id="addTeacher_list">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="${res}/admin/lecturer/add.html"><span><img src="${res}/images/t01.png"></span>新增讲师</a>-->
					...
					<input class="nexnt addStepOne" name="stop" value="下一步" type="button" />
					<input class="nexnt saveStepOne" name="stop" type="button" value="保存">
				...
				<div class="box-course hidden">
					<table class="form_table" width="100%" cellspacing="0"
						...
						<tr>
							...
							<tr>
								<td class="td_right" style="width: 100px;">&nbsp;</td>
								<td style="width: 200px;"><input name="button"
		...
		<div class="chooseteacherinfo">
			<ul class="prosearch">
				<li><a style="padding-left: 10px;"><input name=""
						class="input-text teacherName" placeholder="专家姓名" type="text"></a>
	  ...
	  if(coverId != null && coverId != ""){
		...
		//上传封面
		 $("#upload_org_code").uploadify({
                 ...
                 'uploader'      : '${res}/admin/course/uploadCover.html;jsessionid='+sessionId,
                 'auto'          : true,
                 'multi'         : true,
                 'debug'     : false, //开启调试  
...
/*    	var coverName = $(".coverName").val();
    ...
    //添加教师
    $("#addTeacher_list").click(function(){
      $("#addteacher").show();
      $(".mask").show();
    });
    $(".chooseteachertop a").click(function(){
      $(".mask").hide();
      $("#addteacher").fadeOut(200);
    });
  //layer日历插件
  laydate.skin('molv');
  laydate({
