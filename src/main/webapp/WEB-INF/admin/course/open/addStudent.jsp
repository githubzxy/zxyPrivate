               ...
               <tr>
                    ...
                    <td>
                       <span class="pl25 ml15">
                            <a href="${res}/course/open/toImportStudents.html?openId=${list.openId}&courseName=${list.courseName}" class="ext_btn ext_btn_submit mr20">添加学生</a>
                            <a href="${res}/course/open/toOpenCourseStudents.html?openId=${list.openId}" class="ext_btn ext_btn_success">查看学生</a>
                       </span> 
                    </td>
                </tr>
                </c:forEach>
...
var  $openStr=$("#openStr");
 ...
 function PageTmp(courseName,courseTypeId,courseId,isEnd,size,page){
 	...
 	$.ajax({
 		  type: "POST",
 		  url: "${res}/course/open/addStu.html",
 		  processData:true,
 ...
 function HtmlTmp(datas,htmlStr,startIndex){
 	...
 	$.each(datas, function (index, openCourse) {
 		...
 		//alert(subject.createDate/1000);
 			...
 			htmlStr+="<a href='${res}/course/open/toImportStudents.html?openId="+openCourse.openId+"&courseName="+openCourse.courseName+"' class='ext_btn ext_btn_submit mr10'>添加学生</a> ";
 			htmlStr+='<a href="${res}/course/open/toOpenCourseStudents.html?openId='+openCourse.openId+'" class="ext_btn ext_btn_success">查看学生</a>';
 			htmlStr+="</span> ";
 			htmlStr+="</td> ";
 			htmlStr+="</tr>";
      });
