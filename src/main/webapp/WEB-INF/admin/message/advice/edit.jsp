...
<div class="rightinfo">   
  <div class="formbody">
     ...
     <div class="padding5">
      ...
      <input name="messageId" type="hidden"  value ="${requestScope.messagePo.messageId}"/>
        <table class="form_table" width="100%" cellspacing="0" cellpadding="0" border="0">
            <tbody>
              <tr>
                <td class="td_right">通知标题：</td>
                <td class=""> <input name="title" class="input-text" size="50" type="text"  datatype="*" value="${requestScope.messagePo.title}"></input></td>
                ...
                <p>${requestScope.messagePo.content}</p>
               </script>
                  </td>
                   <td width="500"><span class="Validform_checktip" style="color:#f00;">*必填项</span></td>
                 </tr>
...
//实例化编辑器
  ...
  $("#edit").click(function(){
		 $.ajax({
			type: 'post',
		    url: '${res}/admin/message/edit.html',
		    dataType:'json',
