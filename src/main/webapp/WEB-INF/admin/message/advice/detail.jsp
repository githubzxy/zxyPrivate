  ...
  <div class="formbody">
     ...
     <div class="padding5">
        <div class="affichedetail">
           <h2 class="affichetitle">${requestScope.messageVo.title}</h2>
           <div class="afficheinfo">
             发布作者:&nbsp;${requestScope.messageVo.fromUser.name}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;发布时间:&nbsp;<fmt:formatDate type="both" 
            						dateStyle="short" timeStyle="short" 
           					 		value="${requestScope.messageVo.fromDate}" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;接收者:&nbsp;${requestScope.messageVo.toUser.name}
           </div>
           <div class="infos">
             <p>${requestScope.messageVo.content}</p>
           </div>
        </div>
     </div>
  </div>
