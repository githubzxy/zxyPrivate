         ...
         <table class="form_table"  cellspacing="0" cellpadding="0" border="0">
            <tbody>
              ...
              <input type="hidden" name="teacherId" value="${users.teacherPo.teacherId}">
                ...
                <td><input type="text" name="name" class="input-text" size="30" datatype="*2-4" errormsg="姓名名称必须是2到4位字符！" value="${users.name}" ></td>
                <td width="400"><span class="Validform_check" style="color:#f00;">*必填项</span></td>
                 <td class="td_right">出生日期：</td>
                <td><input type="text" value="<fmt:formatDate value="${users.birthday2}"   pattern="yyyy-MM-dd"/>" name="birthday"  class="input-text laydate-icon" id="birthday" size="25"></td>
             ...
             <tr>
              <td class="td_right">性别：</td>
               ...
               <td><input type="text" name="email" class="input-text" ignore="ignore"  size="25" datatype="e" errormsg="邮箱地址格式不对！" value="${users.email}"></td>
                <td width="400"><span class="Validform_check">*选填项</span></td>
             </tr>
              <tr>
                <td class="td_right">登录密码：</td>
                <td><input  type="password" value="${users.loginPo.loginPwd}" name="loginPwd" datatype="*6-15" errormsg="密码范围在6~15位之间！" nullmsg="请输入密码！" class="input-text" size="30"></td>
                 <td width="400"><span class="Validform_check"  style="color:#f00;">*必填项</span></td>
                 <td class="td_right">确认密码：</td>
                <td><input type="password"  value="${users.loginPo.loginPwd}" datatype="*" recheck="loginPwd" errormsg="您两次输入的账号密码不一致！"  nullmsg="请确认密码！" class="input-text" size="25"></td>
                 <td width="400"><span class="Validform_check" style="color:#f00;">*必填项</span></td>
              </tr>
               <tr>
                <td class="td_right">手机号码：</td>
                <td colsp><input type="text" name="mobile" class="input-text" ignore="ignore" size="30" datatype="m" errormsg="请正确输入11位手机号码！" value="${users.mobile}"></td>
                <td width="400"><span class="Validform_check">*选填项</span></td>
                <td class="td_right" >职称：</td>
                <td><input type="text" name="position" class="input-text" size="25" value="${users.teacherPo.position}"></td>
                <td width="400"><span class="Validform_checktip">*选填项</span></td>
              </tr>
              ...
              <tr>
                ...
                <td><input type="text" name="number" id="tnumber" class="input-text" size="30" datatype="s4-11" sucmsg="工号验证通过！"  nullmsg="请输入工号！" errormsg="工号范围在4~12位之间"  ajaxurl="" value="${users.number}"></td>
                <td width="400"><span class="Validform_check" style="color:#f00;">*必填项</span></td>
                 <td class="td_right" width="150">部&nbsp;门：</td>
                <td><input type="text" name="department" class="input-text" size="25" value="${users.teacherPo.department}"></td>
                 <td width="400"><span class="Validform_checktip" >*选填项</span></td>
              </tr>
             <tr>
              ...
              <td class="td_right">&nbsp;</td>
               <td>
                ...
                <input name="button" class="ext_btn ext_btn_error" value="重置" type="reset" onclick="document.location.href='update.html'"> 
                </td>
                <td width="400"></td>        
              </tr> 
            </tbody>
    ...
    callback:function(data){
    	if (1 == data.flag) {
			layer.alert(data.msg,{icon:1},function(){
				window.location.href="${res}/admin/teacher/update.html";
			});
		}else if(2== data.flag){
