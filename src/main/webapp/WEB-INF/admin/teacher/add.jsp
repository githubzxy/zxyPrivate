...
<div class="rightinfo">   
  <div class="formbody">
     <div class="formtitle"><span>新建教师</span></div>
     <div class="padding5">
      <form class="jqtransform" action="${res}/admin/teacher/add.html"  >
         <table class="form_table"  cellspacing="0" cellpadding="0" border="0">
            <tbody>
              <tr>
                <td class="td_right">姓名：</td>
                <td><input type="text" name="name"  id="tname"class="input-text" size="30" datatype="*2-4" errormsg="姓名名称必须是2到4位字符！" nullmsg="请输入姓名！"></td>
                <td width="400"><span class="Validform_check" style="color:#f00;">*必填项</span></td>
                 <td class="td_right">出生日期：</td>
                <td><input type="text" value="" name="birthday" class="input-text laydate-icon" id="birthday" size="25"></td>
                 <td width="400"><span class="Validform_checktip">*选填项</span></td>
              </tr>
             <tr>
              <td class="td_right">性别：</td>
               <td><input type="radio" value="1" name="gender" id="male"  datatype="*" errormsg="请选择性别！" /><label>男</label> <input type="radio" value="2" name="gender" id="female" /><label>女</label></td>
               <td width="400"><span class="Validform_check" style="color:#f00;">*必填项</span></td>
               <td class="td_right" >个人邮箱：</td>
               <td><input type="text" name="email" id="temail" ignore="ignore" class="input-text"  datatype="e" ignore="ignore" errormsg="邮箱地址格式不对！" size="25"></td>
                <td width="400"><span class="Validform_check" >*选填项</span></td>
             </tr>
              <tr>
                <td class="td_right">登录密码：</td>
                <td><input  type="password" value="" name="loginPwd" id="tpassword" datatype="*6-15" errormsg="密码范围在6~15位之间！" class="input-text" size="30" nullmsg="请输入密码！"></td>
                 <td width="400"><span class="Validform_check"  style="color:#f00;">*必填项</span></td>
                 <td class="td_right">确认密码：</td>
                <td><input type="password" value=""  datatype="*" recheck="loginPwd" errormsg="您两次输入的账号密码不一致！"  class="input-text" size="25" nullmsg="请确认密码！"></td>
                 <td width="400"><span class="Validform_check" style="color:#f00;">*必填项</span></td>
              </tr>
               <tr>
                <td class="td_right">手机号码：</td>
                <td><input type="text" name="mobile" id="tmobile" ignore="ignore" class="input-text" size="30" datatype="m" errormsg="请正确输入11位手机号码！"></td>
                <td width="400"><span class="Validform_check">*选填项</span></td>
                <td class="td_right" >职称：</td>
                <td><input type="text" name="position" class="input-text" ignore="ignore" id="tposition" size="25" datatype="s2-8" errormsg="职称为2-8为位中文字符！" ></td>
                <td width="400"><span class="Validform_check">*选填项</span></td>
              </tr>
              <tr>
                 <td class="td_right">工&nbsp;号：</td>
                <td><input type="text" name="number" id="tnumber" class="input-text" size="30" datatype="s4-11"  sucmsg="工号验证通过！"  nullmsg="请输入工号！" errormsg="工号范围在4~12位之间" ajaxurl=""></td>
                <td width="400"><span class="Validform_check" style="color:#f00;">*必填项</span></td>
                 <td class="td_right" width="150">部&nbsp;门：</td>
                <td><input type="text" name="department"  class="input-text" ignore="ignore" id="tdepartment"  size="25"></td>
                 <td width="400"><span class="Validform_checktip" >*选填项</span></td>
              </tr>
             <tr>
                <td class="td_right">身份证号码：</td>
                <td><input type="text" name="idCard"  id="tIdCard" size="30" datatype="idCard" size="30" ignore="ignore" errormsg="身份证号码必须是15/18位！"  class="input-text"></td>
                 <td width="400"><span class="Validform_check" >*选填项</span></td>
			    ...
			    <input name="file" type="file" id="up" class="filePrew"  onclick="updateBeforeImg();">
              	...
              	<img id="ImgPr" onload="javascript:DrawImage(this,150,150)"/>
				</td>
				<td width="500">
				</td>
              </tr>
              <tr>
                ...
                <td colspan="1"><textarea name="info" id="tinfo" cols="30" rows="10" class="textarea" style="width:245px;height:120px;"></textarea></td>
                 <td width="400"><span class="Validform_checktip">*选填项</span></td>
	 ...
	 if(flag){
		 var formData=$(".jqtransform").serialize();
			...
			jQuery(".jqtransform").ajaxSubmit({
				  type: "POST",
				  url: "${res}/admin/teacher/add.html",
				  processData:true,
				  data:formData,
				  dataType: "json",
