...
<div class="rightinfo">   
  <div class="formbody">
     <div class="formtitle"><span>修改角色</span></div>
     <div class="padding5">
     <form id="roleForm" action="/admin/role/${role.roleId }/update.html">
     <input type="hidden" id="roleId" value="${role.roleId }"></input>
     <script type="text/javascript" src="${res}/plugin/layer/layer/layer.js"></script><!--弹窗-->
        <table class="form_table" width="100%" cellspacing="0" cellpadding="0" border="0">
            <tbody>
              <tr>
                <td class="td_right">角色名称：</td>
                <td class=""> <input name="roleName" id="roleName" class="input-text" size="40" type="text" value="${role.roleName }" datatype="s1-20" errormsg="范围在1~20位之间" ></input></td>
                <td width="400"><span class="Validform_check moveNum" style="color:#f00;">*必填项</span><span class="checkNum" style="color:#f00;"></span></td>
                 ...
                 <tr>
                  ...
                  <td class="">
                    <input name="roleCode" id="roleCode" class="input-text" size="40" type="text" value="${role.roleCode }" disabled="disabled" ></input>
                  </td>
                 </tr>
                 <tr>
                   <td class="td_right">&nbsp;</td>
                   <td class="">
                     <input name="button" class="ext_btn ext_btn_submit" id="updateRole" value="保存" type="button">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
$("#updateRole").click(function(){
	...
	$.ajax({
		  type: "POST",
		  url: "${res}/admin/role/"+roleId+"/update.html",
		  processData:true,
		  ...
		  success: function(data){
	    		if(1 == data.flag){
	    			layer.alert(data.msg,{icon: 1, title:'提示'},function(){
    				  document.location.href="/admin/role/list.html";
    			  });;
	    		}else{
